    ...
    <div className="layout">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">
          <a
            href="https://github.com/ntygod/Zentwine/tree/main/docs"
            target="_blank"
            rel="noopener noreferrer"
          >
            开发计划与项目文档 ↗
          </a>
          <small>基础能力按真实状态展示</small>
        </div>
      </aside>
      <div className="main-column">
        ...
        <main className="page" id="main">
          <div className="page-header">
            <div>
              <div className="eyebrow">BUILD TOGETHER. DELIVER AS ONE.</div>
              <h1>团队的下一次协作，从这里开始。</h1>
              <p>管理工作台与独立 Studio，共用一套事实与交付边界。</p>
            </div>
            <a
              ...
              rel="noopener noreferrer"
            >
              打开独立 Studio <span aria-hidden="true">↗</span>
            </a>
          </div>
          <ConnectionAlert connection={connection} retry={retry} />
          <div className="notice">
            <strong>当前为工程基础版本。</strong> 页面连接真实只读
            API；身份、持久化与模型执行尚未接通。没有创建任何项目、工作区或
            Run。
          </div>
          <section className="hero" aria-label="工作入口">
            <div>
              <div className="eyebrow">ONE TEAM · MANY INTELLIGENCES</div>
              <h2>
                从共同的目标，走向
                <br />
                可以验证的交付。
              ...
              <p>
                为需求、团队和不同模型建立共同的工作环境。先把上下文与责任连接，再让执行持续向前。
              </p>
              <div className="hero-links">
                ...
                <a
                  ...
                  href="https://github.com/ntygod/Zentwine"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  查看工程进展
            ...
            <div className="journey">
              {[
                ["01", "明确需求与约定", "批准的目标，版本化的上下文"],
                ["02", "组织人机协作", "独立工作区，清晰分工与授权"],
                ["03", "依据证据交付", "代码、验证与验收相互关联"],
              ].map(([n, title, desc]) => (
          ...
          <div className="grid-two">
            <section className="card">
              <header className="card-header">
                <h2>交付空间</h2>
                <span className="state-off">尚未接通</span>
              </header>
              <div className="empty">
                ...
                <h3>还没有可读取的交付单元</h3>
                <p>
                  组织身份与业务持久化完成后，这里将展示真实项目。不使用样例进度或虚构任务填充看板。
                </p>
                <span className="muted">下一阶段：组织 · 需求 · 工作包</span>
              </div>
            </section>
            <section className="card">
              <header className="card-header">
                <h2>Agent 基座</h2>
                <span className="state-off">执行关闭</span>
              </header>
              <div className="runtime-list">
                {["Claude Agent SDK", "Codex"].map((name, index) => (
                  <div className="runtime" key={name}>
