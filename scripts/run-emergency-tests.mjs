...
try {
  ...
  const files =
    mode === "--browser"
      ? ["tests/emergency/browser.test.mjs"]
      : [
          "tests/emergency/persistence.test.mjs",
          "tests/emergency/http.test.mjs",
        ];
  ...
  console.error(
    "Emergency verification requires acknowledged disposable PostgreSQL and built tools; no integration was silently skipped.",
  );
  process.exitCode = 1;
}
